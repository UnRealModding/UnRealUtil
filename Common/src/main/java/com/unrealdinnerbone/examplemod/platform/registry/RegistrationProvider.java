package com.unrealdinnerbone.examplemod.platform.registry;

import com.unrealdinnerbone.examplemod.platform.Services;
...
public interface RegistrationProvider<T> {
    ...
    static <T> RegistrationProvider<T> get(ResourceKey<? extends Registry<T>> resourceKey, String modId) {
        return Services.getFactory().create(resourceKey, modId);
    }
